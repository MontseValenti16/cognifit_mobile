class SessionRecordEntity {
  ...
  final int delta;
  final bool isRisk;
  const SessionRecordEntity({required this.dayLabel, required this.time, required this.score, required this.delta, required this.isRisk});
}
